...
button = UI.Button(100,300,w=10,h=5,text="Button",calculateSize=True,outline=True,background = (200,200,200), action = button_clicked,enlarge=True)
button2 = UI.Button(200,300,w=120,h=35,text="Button2",half_outline=True,background = (200,200,200), hover_background_color=(255,0,0))
